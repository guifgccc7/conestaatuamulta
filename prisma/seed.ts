...
async function main() {
  ...
  await prisma.legalTemplate.upsert({
    ...
    create: {
      ...
      legalBasis:  JSON.stringify(["CE Art.24", "RGCO Art.58", "RGCO Art.68", "DL 291/90", "Portaria 1504/2008"]),
      isActive:    true,
      version:     1,
    },
  ...
  await prisma.legalTemplate.upsert({
    ...
    create: {
      ...
      bodyText:    "{{generated_by_code}}",
      legalBasis:  JSON.stringify(["CE Art.48", "CE Art.49", "RGCO Art.58", "DL 307/2003"]),
      isActive:    true,
      version:     1,
    },
    update: { isActive: true },
  ...
  await prisma.legalTemplate.upsert({
    ...
    create: {
      ...
      bodyText:    "{{generated_by_code}}",
      legalBasis:  JSON.stringify(["RGCO Art.58", "RGCO Art.27", "RGCO Art.70", "CRP Art.32"]),
      isActive:    true,
      version:     1,
    },
    update: { isActive: true },
